...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Server-canonical mobile features use this absolute HTTPS origin. This is
    | public configuration, not a credential. Keep authentication tokens and
    | all server secrets out of bundled environment files.
    |
    */

    'api_url' => env('NATIVEPHP_API_URL'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | `php artisan native:verify-bundle <archive>` checks these paths as well
    | as every environment pattern above. Run it against the release Laravel
    | bundle before signing or uploading an application archive.
    |
    */
