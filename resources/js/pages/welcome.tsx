        ...
        <>
            ...
            <div className="relative flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                >
                    <button
                        type="submit"
                        className="rounded-sm border border-black/15 bg-white px-4 py-1.5 text-sm font-medium transition hover:border-black/30 hover:bg-[#f7f7f5] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f53003] dark:border-white/15 dark:bg-[#161615] dark:text-[#ededec] dark:hover:border-white/30 dark:hover:bg-[#20201f]"
                    >
                        Log out
                    </button>
                </Form>
