...
This rule is engine- and version-specific. Confirm the production database,
table size, transaction behavior, and exact query plan before using raw DDL.
It does not apply to this boilerplate's default SQLite database.
