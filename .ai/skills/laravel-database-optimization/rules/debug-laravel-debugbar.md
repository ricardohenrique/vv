...
This is optional dependency advice. Use it only when Debugbar is already
installed or the user explicitly approves adding it. Otherwise use installed
profiling tools, query listeners in a focused local investigation, database
slow-query logs, and query-plan inspection.
