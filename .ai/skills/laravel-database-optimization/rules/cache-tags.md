...
First inspect `config/cache.php`. Cache tags are unavailable on the database,
file, and array stores; do not apply this rule unless a supported Redis or
Memcached store is configured for the relevant environment.
