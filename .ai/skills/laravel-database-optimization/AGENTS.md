...
> Project rules and installed capabilities take precedence over every example
> below. Inspect the configured database and cache drivers, schema, query plan,
> and dependencies first. Redis/cache tags, Laravel Debugbar, PostgreSQL
> concurrent indexes, MySQL online DDL, and automatic eager loading are
> conditional techniques, not boilerplate defaults.
