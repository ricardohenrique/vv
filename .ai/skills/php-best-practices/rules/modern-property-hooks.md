...
Property hooks are a plain-PHP tool. Do not introduce them on Eloquent models
as a replacement for Laravel casts, `Attribute` accessors, mass-assignment
rules, or relationship methods unless the installed Laravel version explicitly
supports that interaction and the project already follows the pattern.
